...
const App = () => {
  ...
  return (
    <Box sx={{ p: 4, maxWidth: 1200, mx: "auto" }}>
      <Typography
        variant="h4"
        sx={{ mb: 3, fontWeight: "bold", color: "#0077B6", textAlign: "center" }}
      >
      ...
      >
        Record a voice command to search candidates. Results will be sent via Slack or Email
        and displayed below.
      </Typography>
                    ...
                    <CardContent>
                      ...
                      >
                        <Typography variant="body2">
                          <strong>Experience:</strong> {c.experience_years} years | {" "}
                          <strong>Match:</strong> {c.match_score}%
                        </Typography>
                      </Box>
                      ...
                      {c.phone && (
                        <Typography variant="body2" sx={{ mb: 0.5 }}>
                          <strong>Phone:</strong>{" "}
                          <a href={`tel:${c.phone}`} style={{ color: "#0077B6" }}>
                            {c.phone}
                          </a>
                        </Typography>
                      )}
                      ...
                      <Typography variant="body2" sx={{ mb: 0.5 }}>
                        <strong>Salary:</strong> €{c.salary?.toLocaleString()}/month
                      </Typography>

                      <Typography variant="body2" sx={{ mb: 0.5 }}>
                        <strong>Location:</strong> {c.location?.city} ({c.location?.postal_code})
                      </Typography>
                      ...
                      <Typography variant="body2" sx={{ mb: 1 }}>
                        <strong>Education:</strong> {c.education?.level} - {c.education?.institution}
                      </Typography>
